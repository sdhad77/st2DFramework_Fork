package com.sundaytoz.st2D
{
    ...
    public class st2DFramework extends Sprite
    {
        ...
        private function onInited():void
        {
            ...
            AnimationData.instance.setAnimationData("res/box.png", "res/boxAtlas.xml");
            ...
            AnimationData.instance.setAnimation("res/box.png",  new Animation("broken",new Array("broken0","broken1","broken2",
            ...
            sprite4.setTextureWithString("res/box.png");      
